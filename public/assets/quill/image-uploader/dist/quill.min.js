      ...
      var s = (function () {
        ...
        x = (function (t) {
            function e(t, n) {
                ...
                // Gunakan MutationObserver sebagai pengganti DOMNodeInserted
                const observer = new MutationObserver((mutationsList) => {
                    mutationsList.forEach((mutation) => {
                        if (mutation.type === 'childList') {
                            // Tangani node yang ditambahkan atau dihapus
                            // console.log('Node inserted or removed:', mutation);
                        }
                    });
                });
            
                // Amati perubahan di dalam `r.domNode`
                observer.observe(r.domNode, {
                    childList: true, // Perhatikan perubahan child nodes
                    subtree: true,   // Perhatikan perubahan di semua tingkat subtree
                });
