...
@endsection
@section('breadcrumb')
    {{ Breadcrumbs::render('master_permission') }}
@endsection
@section('page-title')
    Master Permission
@endsection
                ...
                <form action="{{ route('store_permission') }}" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="" class="col-form-label">Permission Name:</label>
                            <input class="form-control @error('name') is-invalid @enderror" placeholder="Permission Name..."
                ...
                <form action="" id="edit-form" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('name') is-invalid @enderror" placeholder="Permission Name..."
                                type="text" id="permission-name" name="name" value="{{ old('name') }}" required>
                            @error('name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on("click", ".delete-modal", function() {
            let url = $(this).data('url');
            let name = $(this).data('name');
            $("#delete-text").html(`Apa anda yakin menghapus permission ${name}?`);
