...
@endsection
@section('breadcrumb')
    {{ Breadcrumbs::render('edit_developer_bank', $bank) }}
@endsection
@section('page-title')
    Edit Developer Bank
@endsection
                                ...
                                <div class="col-md-5 mb-3">
                                    <div class="form-group">
                                        <div class="image-preview form-control @error('image') is-invalid @enderror"
                                            ...
                                            @php
                                                $image = old('image') ?? $bank->image;
                                            @endphp
                                            <img class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover"
                                                src="{{ storage_url($image, null, asset('/assets/images/choose_file_3x1.jpg')) }}"
                                                alt="Image Preview">
                                ...
                                <div class="col-md-7 mb-3">
                                    ...
                                    @hasrole('superadmin')
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="old_developer"
                                                value="{{ old('developer_id') ?? $bank->developer_id }}">
                                            @error('developer_id')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
