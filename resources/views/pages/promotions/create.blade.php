            ...
            <div class="col-xl-8 col-md-9 col-12 mt-4">
                <div class="card mb-4">
                    <div class="card-header pb-0 p-3">
                        <h6 class="mb-1">Create Promotion</h6>
                    </div>
                    <div class="card-body p-3">
                        <form action="{{ route('store_promotion') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="mb-3 form-floating">
                                <textarea class="form-control @error('content') is-invalid @enderror" placeholder="Leave a description content here"
                                    id="content" name="content" style="height: 200px">{{ old('content') }}</textarea>
