            ...
            <div class="col-xl-8 col-md-9 col-12 mt-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body p-3">
                        <form action="{{ route('update_bill', ['id' => $bill->id]) }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            <div class="form-group mb-3">
                                ...
                                <input type="hidden" id="old_project"
                                    value="{{ old('project_unit_id') ?? $bill->project_unit_id }}">
                                    ...
                                    @if ($billTypes)
                                        @foreach ($billTypes as $type)
                                            <option value="{{ $type->id }}" data-input-title="{{ $type->is_edit }}"
                                                ...
                                                @if ((old('bill_type_id') ?? $bill->bill_type_id) == $type->id) selected @endif>{{ $type->name }}
                                            </option>
                                        @endforeach
                                    @endif
                                </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="month"
                                    value="{{ old('usage_period_at') ?? $bill->usage_period_at->format('Y-m') }}"
                                    id="usage_period_at" name="usage_period_at" required>
                            </div>
                            <div class="form-group mb-3">
                                <label for="billed_at" class="form-control-label">Bulan Penagihan</label>
                                <input class="form-control" type="month"
                                    value="{{ old('billed_at') ?? $bill->billed_at->format('Y-m') }}" id="billed_at"
                                    name="billed_at" required>
                            </div>
                            ...
                            <div class="form-group mb-3 d-none" id="group-end-value">
                                ...
                                <input type="text" class="form-control @error('end_value') is-invalid @enderror"
                                    id="end_value" name="end_value" placeholder=""
                                    value="{{ old('end_value') ?? $bill->end_value }}">
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control text-end @error('value') is-invalid @enderror"
                                    id="bill_value" name="value" placeholder=""
                                    value="{{ old('value') ?? $bill->value }}" oninput="sumTotalValue()" required>
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control text-end @error('tax') is-invalid @enderror"
                                    id="tax_value" name="tax" placeholder="" value="{{ old('tax') ?? $bill->tax }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control text-end @error('penalty') is-invalid @enderror"
                                    id="penalty_value" name="penalty" placeholder=""
                                    value="{{ old('penalty') ?? $bill->penalty }}" oninput="sumTotalValue()">
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('discount') ?? $bill->discount }}" oninput="sumTotalValue()">
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('bill_release') ?? $bill->bill_release }}" oninput="sumTotalValue()">
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('penalty_release') ?? $bill->penalty_release }}"
                                    oninput="sumTotalValue()">
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control text-end @error('paid') is-invalid @enderror"
                                    id="paid_value" name="paid" placeholder=""
                                    value="{{ old('paid') ?? $bill->paid }}" oninput="sumTotalValue()">
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control text-end @error('total') is-invalid @enderror"
                                    id="total_value" name="total" placeholder=""
