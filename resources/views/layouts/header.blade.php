...
<link rel="icon" type="image/png" href="{{ asset('assets/soft-ui/img/favicon.png') }}">
<title>{{ $title }}</title>
...
<script src="{{ asset('assets/src/plugins/jquery/js/jquery-3.7.1.min.js') }}" crossorigin="anonymous"></script>
