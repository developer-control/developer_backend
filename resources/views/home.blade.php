                            ...
                            <div class="card-body p-3 position-relative">
                                <div class="row">
                                    <div class="col-8 text-start">
                                        <div
                                            class="icon icon-shape bg-white shadow border-radius-2xl d-flex align-items-center justify-content-center">
                                            <i class="fas fa-city text-dark text-gradient text-lg opacity-10"
                                                aria-hidden="true"></i>
                                        </div>
                                        <h5 class="text-white font-weight-bolder mb-0 mt-3">
                                            1600
                                        </h5>
                                        <span class="text-white text-sm">Total Project</span>
                                    </div>
                                    <div class="col-4">
